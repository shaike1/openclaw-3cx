...
var config = {
  ...
  sip: {
    ...
    auth_id: process.env.SIP_AUTH_ID || "YOUR_SIP_AUTH_ID",
    password: process.env.SIP_AUTH_PASSWORD || "YOUR_SIP_PASSWORD",
    domain: process.env.SIP_DOMAIN || "YOUR_COMPANY.3cx.cloud",
    registrar: process.env.SIP_REGISTRAR || "YOUR_COMPANY.3cx.cloud",
    registrar_port: parseInt(process.env.SIP_REGISTRAR_PORT) || 5060,
    expiry: parseInt(process.env.SIP_EXPIRY) || 3600
  },
  external_ip: process.env.EXTERNAL_IP || "YOUR_SERVER_LAN_IP",
